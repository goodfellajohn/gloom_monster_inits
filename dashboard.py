...
st.markdown(f'<h1 style="background: yellow;font-size:30px;font-family:Helvetica;">{"Sister Mary Clarence & Vlad II Killéus Conquest"}</h1>', unsafe_allow_html=True)
st.markdown(f'<h2 style="background: yellow;font-size:24px;font-family:Helvetica;">{"Important Details"}</h2>', unsafe_allow_html=True)
...
st.write(df_selection.style.apply(highlight_elite,axis=1)).set_properties(**{'background-color': 'black',
                           'color': 'green'})
